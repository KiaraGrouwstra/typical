...
// Operations for string-based booleans (`'0'` / `'1'`). These are no longer the only types we can use for conditionals, but remain of value for recursion and complex conditionals.
